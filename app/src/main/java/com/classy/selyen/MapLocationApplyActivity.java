...
public class MapLocationApplyActivity extends AppCompatActivity implements OnMapReadyCallback, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!UserData.getString("addr", "").equals("null")){
            ...
            scan_check = true;
            change_location_menu_btn.setText("주소 등록하기");
        }
    ...
    public void onClick_refresh(View v){
        scan_check = true;
        Toast.makeText(this, "현재위치를 다시 찾아볼게요!", Toast.LENGTH_LONG).show();
        customAnimationLoadingDialog.show();
    }
    ...
    public String getCurrentAddress(LatLng latlng) {
        ...
        if (addresses == null || addresses.size() == 0) {
            ...
            state_check = 0;
            return "주소정보를 찾지 못했어요 ㅠ 다시 시도해주세요...";
    ...
    public void setCurrentLocation(Location location, String markerTitle, String markerSnippet) {
        ...
        markerOptions.title(markerTitle);//마커타이틀에 위치정보
        markerOptions.snippet("내 현재 위치");//서브에 텍스트
        //markerOptions.snippet(markerSnippet);//서브에 위도,경도
        ...
        location_text.setText(markerTitle.replaceFirst("대한민국 ",""));
    ...
    class InsertData extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String addr = (String)params[2];//입력 데이터

            String serverURL = (String)params[0];//서버주소 할당
            String postParameters = "request_type=" + "ch_addr" +"&ph_num=" + ph_num + "&request_Contents=" + addr ;//전송할 파라미터,값
